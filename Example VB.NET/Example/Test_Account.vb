...
Public Class Test_Account
    ''' <summary>
    ''' Event handler for Submit button - processes username/password authentication
    ''' </summary>
    Private Sub Button_Submit_Click(sender As Object, e As EventArgs) Handles Button_Submit.Click
        ...
        ' Authenticate user with username, password, and HWID
        Dim result = AuthUser(Text_Username.Text, Text_Password.Text, hwid)
